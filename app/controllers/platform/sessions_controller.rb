class Platform::SessionsController < ApplicationController
  ...
  def create
    ...
    if staff && staff.authenticate(password)
      ...
      PlatformSession.create!(platform_staff: staff, token_hash: token, ip_address: request.remote_ip, user_agent: request.user_agent.to_s[0, 200], expires_at: 24.hours.from_now)
